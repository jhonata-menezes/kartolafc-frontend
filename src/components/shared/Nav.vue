    ...
    <div>
        <nav class="navbar has-shadow-nav">
            <div class="navbar-brand">
              <router-link v-if="!$route.query.logo"  class="navbar-item" to="/"><img crossorigin="anonymous" class='image' src="/static/img/logo.png" alt="KartolaFC logo">&nbspartolaFC</router-link>
